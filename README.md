...
### Last changes
* `addRandomInd` function sintaxis changed slightly. It allows now to select the intervening subset of base individuals. See example in [main.py](https://github.com/miguelperezenciso/SeqBreed/blob/master/main.py)
